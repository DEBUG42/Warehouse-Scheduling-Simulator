...
private:
    // 单位转换常量 *比main分支多出的
    static constexpr float MM_TO_PIXEL = 0.05f; // 毫米到像素的转换因子 (1mm = 0.05px)    // 轨道几何数据
    ...
    // 实际物理尺寸缓存（毫米）*比main分支多出的
    float m_straightLength = 40000.0f; // 直道长度
    float m_curveRadius = 2500.0f;     // 弯道半径
